        ...
        <!-- ./col -->
            <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box bg-green">
                    <div class="inner">
                        <h3>{{ \App\Models\Stock::whereMonth('created_at', '=', now()->month)->count() }}<sup style="font-size: 20px"></sup></h3>
            ...
            <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box bg-green">
                    <div class="inner">
                        <h3>{{ \App\Models\Legacy::whereMonth('created_at', '=', now()->month)->count() }}<sup style="font-size: 20px"></sup></h3>
            ...
            <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box bg-green">
                    <div class="inner">
                        <h3>{{\App\Models\Owner::count() }}<sup style="font-size: 20px"></sup></h3>
