				...
				<div class="sidemenu-container navbar-collapse collapse fixed-menu">
					<div id="remove-scroll" class="left-sidemenu">
						<ul class="sidemenu  page-header-fixed slimscroll-style" data-keep-expanded="false"
							...
							<li class="nav-item">
								<a href="event.html" class="nav-link nav-toggle"> <i class="material-icons f-left">business</i> 
									<span class="title">Properties</span>
								</a>
							</li>

							<li class="nav-item">
								<a href="all_students.html" class="nav-link nav-toggle"> <i data-feather="users"></i>
									<span class="title">Tenants</span>
								</a>
							</li>
							<li class="nav-item">
								<a href="#" class="nav-link nav-toggle"><i data-feather="users"></i>
									<span class="title">Agents</span><span class="arrow"></span></a>
								<ul class="sub-menu">
									<li class="nav-item">
							...
							<li class="nav-item">
								...
								<ul class="sub-menu">
									<li class="nav-item">
										<a href="all_front.html" class="nav-link "> <span class="title">All Library
												front</span>
										</a>
									</li>
									<li class="nav-item">
