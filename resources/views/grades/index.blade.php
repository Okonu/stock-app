...
@section('content')
    <div class="box box-success">
        ...
        <!-- /.box-header -->
        <div class="box-body">
            <table id="grades-table" class="table table-bordered table-hover table-striped">
                <thead>
                <tr>
                    <th>#</th>
                    <th>Name</th>
        ...
        $(function(){
            $('#modal-form form').validator().on('submit', function (e) {
                if (!e.isDefaultPrevented()){
                    var id = $('#id').val();
                    if (save_method == 'add') url = "{{ url('grades') }}";
                    else url = "{{ url('grades') . '/' }}" + id;
